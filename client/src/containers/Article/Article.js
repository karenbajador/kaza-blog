    ...
    return (
      ...
      <div className='container'>
        ...
        <div className='article-bodyContainer'>
          <div className='article-date article-text-date'>Aug 14, 2017</div>
          ...
          <div className='tags'>Tags:
            <Link to='/posts/tags/tag'><span className='tag'>Tag1</span></Link>
            <Link to='/posts/tags/tag'><span className='tag'>Tag2</span></Link>
            <Link to='/posts/tags/tag'><span className='tag'>Tag3</span></Link>
          </div>
        </div>
        <div className='article-side' />
      </div>
